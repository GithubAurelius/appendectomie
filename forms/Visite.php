        ...
        <tr>
            <td width='99%' valign='top'>
				...
				<div class='row' style='height:0;visibility: collapse;'>
                    ...
                    <div class='col_a' id='SH_92_a'>
                        <div class='desc_f' >Pseudonym</div>
                    </div>
			...
			<fieldset id='FS_'><legend><img height='16px' src='../images/dataentry.svg'> Visite / Dokumentationen <?=$praxis_id?></legend>
                    ...
                    <div class='col_30' style='display: flex; flex-wrap: nowrap;white-space: nowrap;'>
                        ...
                        <select required id='FF_10005021' name='FF_10005021'  onchange='follow_select(this)'><option value=''></option><option value='Woche 0' <?php if (($form_data_a[10005021] ?? '') == 'Woche 0') echo 'selected'; ?>>Woche 0</option><option value='Woche 2' <?php if (($form_data_a[10005021] ?? '') == 'Woche 2') echo 'selected'; ?>>Woche 2</option><option value='Woche 6' <?php if (($form_data_a[10005021] ?? '') == 'Woche 6') echo 'selected'; ?>>Woche 6</option><option value='Woche 10' <?php if (($form_data_a[10005021] ?? '') == 'Woche 10') echo 'selected'; ?>>Woche 10</option><option value='Woche 16' <?php if (($form_data_a[10005021] ?? '') == 'Woche 16') echo 'selected'; ?>>Woche 16</option><option value='Woche 24' <?php if (($form_data_a[10005021] ?? '') == 'Woche 24') echo 'selected'; ?>>Woche 24</option><option value='Woche 48 (zwischen W24-W48 - Kontrolle)' <?php if (($form_data_a[10005021] ?? '') == 'Woche 48 (zwischen W24-W48 - Kontrolle)') echo 'selected'; ?>>Woche 48 (zwischen W24-W48 - Kontrolle)</option><option value='vorzeitiger Abbruch' <?php if (($form_data_a[10005021] ?? '') == 'vorzeitiger Abbruch') echo 'selected'; ?>>vorzeitiger Abbruch</option>
                        </select>
                    </div>
					<div class='col_b' ><div class='desc_f'></div></div>
					
                    <div class='col_30' style='display: flex; flex-wrap: nowrap;white-space: nowrap;'>
                        <span id='SP_10005020' class='desc_f'>Datum</span>&nbsp;
                        <input required type='date' id='FF_10005020' name='FF_10005020' value="<?php echo htmlspecialchars($form_data_a[10005020] ?? ''); ?>" placeholder=''>
                    </div>
			</fieldset>
